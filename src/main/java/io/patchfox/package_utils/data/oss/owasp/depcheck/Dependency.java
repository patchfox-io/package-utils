...
public class Dependency {
    ...
    private List<VulnerabilityId> vulnerabilityIds = new ArrayList<>();
    ...
    public Dependency withIsVirtual(String isVirtual) {
        this.isVirtual = isVirtual;
        return this;
    }
    ...
    public Dependency withVulnerabilities(List<Vulnerability> vulnerabilities) {
        this.vulnerabilities = vulnerabilities;
        return this;
    }
    ...
    public Dependency withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }

...
public class Checksum__1 {
    ...
    private Checksum__1 .Algorithm algorithm;
    /**
     ...
     * @param algorithm
     */
    public Checksum__1(Checksum__1 .Algorithm algorithm, String checksumValue) {
        super();
     ...
     */
    @JsonProperty("algorithm")
    public Checksum__1 .Algorithm getAlgorithm() {
        return algorithm;
    }
     ...
     */
    @JsonProperty("algorithm")
    public void setAlgorithm(Checksum__1 .Algorithm algorithm) {
        this.algorithm = algorithm;
    }
    ...
    public String toString() {
        ...
        sb.append(Checksum__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("algorithm");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Checksum__1) == false) {
            return false;
        }
        Checksum__1 rhs = ((Checksum__1) other);
    ...
    public enum Algorithm {
        ...
        private final static Map<String, Checksum__1 .Algorithm> CONSTANTS = new HashMap<String, Checksum__1 .Algorithm>();

        static {
            for (Checksum__1 .Algorithm c: values()) {
        ...
        @JsonCreator
        public static Checksum__1 .Algorithm fromValue(String value) {
            Checksum__1 .Algorithm constant = CONSTANTS.get(value);
            if (constant == null) {

 ...
 * Workflow
 * <p>
 * A specialized orchestration task.Workflow are as task themselves and can trigger other workflow tasks.  These relationships can be modeled in the taskDependencies graph.
 * 
 */
...
public class Workflow {
     ...
     * Tasks
     * <p>
     * The tasks that comprise the workflow.Note that tasks can appear more than once as different instances (by name or UID).
     * 
     */
    @JsonProperty("tasks")
    @JsonDeserialize(as = java.util.LinkedHashSet.class)
    ...
    private Set<Dependency> taskDependencies = new LinkedHashSet<Dependency>();
    /**
     * Task types
     * <p>
     ...
     */
    @JsonProperty("taskDependencies")
    public void setTaskDependencies(Set<Dependency> taskDependencies) {
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.taskDependencies == null)? 0 :this.taskDependencies.hashCode()));

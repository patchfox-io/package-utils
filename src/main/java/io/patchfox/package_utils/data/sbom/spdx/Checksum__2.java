...
public class Checksum__2 {
    ...
    private Checksum__2 .Algorithm algorithm;
    /**
     ...
     * @param algorithm
     */
    public Checksum__2(Checksum__2 .Algorithm algorithm, String checksumValue) {
        super();
     ...
     */
    @JsonProperty("algorithm")
    public Checksum__2 .Algorithm getAlgorithm() {
        return algorithm;
    }
     ...
     */
    @JsonProperty("algorithm")
    public void setAlgorithm(Checksum__2 .Algorithm algorithm) {
        this.algorithm = algorithm;
    }
    ...
    public String toString() {
        ...
        sb.append(Checksum__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("algorithm");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Checksum__2) == false) {
            return false;
        }
        Checksum__2 rhs = ((Checksum__2) other);
    ...
    public enum Algorithm {
        ...
        private final static Map<String, Checksum__2 .Algorithm> CONSTANTS = new HashMap<String, Checksum__2 .Algorithm>();

        static {
            for (Checksum__2 .Algorithm c: values()) {
        ...
        @JsonCreator
        public static Checksum__2 .Algorithm fromValue(String value) {
            Checksum__2 .Algorithm constant = CONSTANTS.get(value);
            if (constant == null) {

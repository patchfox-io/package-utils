...
public class Annotation__2 {
    ...
    private Annotation__2 .AnnotationType annotationType;
    /**
     ...
     * @param annotator
     */
    public Annotation__2(String annotationDate, Annotation__2 .AnnotationType annotationType, String annotator, String comment) {
        super();
     ...
     */
    @JsonProperty("annotationType")
    public Annotation__2 .AnnotationType getAnnotationType() {
     ...
     */
    @JsonProperty("annotationType")
    public void setAnnotationType(Annotation__2 .AnnotationType annotationType) {
        this.annotationType = annotationType;
    }
    ...
    public String toString() {
        ...
        sb.append(Annotation__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Annotation__2) == false) {
            return false;
        }
        Annotation__2 rhs = ((Annotation__2) other);
    ...
    public enum AnnotationType {
        ...
        private final static Map<String, Annotation__2 .AnnotationType> CONSTANTS = new HashMap<String, Annotation__2 .AnnotationType>();

        static {
            for (Annotation__2 .AnnotationType c: values()) {
        ...
        @JsonCreator
        public static Annotation__2 .AnnotationType fromValue(String value) {
            Annotation__2 .AnnotationType constant = CONSTANTS.get(value);
            if (constant == null) {

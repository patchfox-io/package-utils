...
public class Annotation__3 {
    ...
    private Annotation__3 .AnnotationType annotationType;
    /**
     ...
     * @param annotator
     */
    public Annotation__3(String annotationDate, Annotation__3 .AnnotationType annotationType, String annotator, String comment) {
        super();
     ...
     */
    @JsonProperty("annotationType")
    public Annotation__3 .AnnotationType getAnnotationType() {
     ...
     */
    @JsonProperty("annotationType")
    public void setAnnotationType(Annotation__3 .AnnotationType annotationType) {
        this.annotationType = annotationType;
    }
    ...
    public String toString() {
        ...
        sb.append(Annotation__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Annotation__3) == false) {
            return false;
        }
        Annotation__3 rhs = ((Annotation__3) other);
    ...
    public enum AnnotationType {
        ...
        private final static Map<String, Annotation__3 .AnnotationType> CONSTANTS = new HashMap<String, Annotation__3 .AnnotationType>();

        static {
            for (Annotation__3 .AnnotationType c: values()) {
        ...
        @JsonCreator
        public static Annotation__3 .AnnotationType fromValue(String value) {
            Annotation__3 .AnnotationType constant = CONSTANTS.get(value);
            if (constant == null) {

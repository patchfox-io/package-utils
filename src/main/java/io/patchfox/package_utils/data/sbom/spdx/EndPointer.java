...
public class EndPointer {
     ...
     * @param lineNumber
     */
    public EndPointer(String reference, Integer offset, Integer lineNumber) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EndPointer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("reference");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EndPointer) == false) {
            return false;
        }
        EndPointer rhs = ((EndPointer) other);
